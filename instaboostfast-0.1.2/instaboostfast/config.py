...
class InstaBoostConfig:
    def __init__(self, action_candidate: tuple = ('normal', 'horizontal', 'skip'),
                 ...
                 theta=(-1, 1), color_prob=0.5, heatmap_flag=False, aug_prob=0.5,
                 use_local=True, beam_nums=[0,1,2], beam_prob=[0.3,0.4,0.3], sync_nums=[0,1,2], sync_prob=[0.3, 0.4, 0.5], stand_eye_prob=0.5):
        """
        ...
        self.sync_nums = sync_nums
        self.sync_prob = sync_prob
        self.stand_eye_prob = stand_eye_prob
