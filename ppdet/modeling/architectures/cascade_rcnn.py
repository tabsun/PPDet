...
class CascadeRCNN(BaseArch):
    ...
    def _forward_swin(self):
        ...
        for i in range(N):
            ...
            rois, rois_num, _ = self.rpn_head(body_feats, block_data)
            preds, _ = self.bbox_head(body_feats, rois, rois_num, block_data)
    ...
    def _forward(self):
        if True: #(self.inputs['image'].shape[0] > 1):
            return self._forward_swin()
